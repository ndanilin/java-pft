 ...
 * 2020-07-11T14:51:59.989+03:00
 * Generated source version: 3.3.7
 *
 */
@WebServiceClient(name = "GeoIPService",
                  wsdlLocation = "file:src/main/resources/geo.wsdl",
...
public class GeoIPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:src/main/resources/geo.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(GeoIPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:src/main/resources/geo.wsdl");
        }
        WSDL_LOCATION = url;
    }
